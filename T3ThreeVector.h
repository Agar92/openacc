...
template <typename T>
ThreeVector<T> cross(ThreeVector<T> const & lhsvector, ThreeVector<T> const & rhsvector);  
//***************************************************************//
...
//operator overloading:  
  ...
  friend ThreeVector cross<>(ThreeVector const & lhsvector, ThreeVector const & rhsvector);  
